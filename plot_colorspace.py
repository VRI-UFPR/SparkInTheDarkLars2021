...
d3_269_colors_rgb = [[0, 0, 166], [255, 74, 70], [0, 137, 65], [153, 0, 153], [96, 96, 96], [255, 128, 0]]
...
def palplot(pal, size=1):
    ...
    f, ax = plt.subplots(1, 1, figsize=(n * 4 * size, size))
    ...
    ax.set_yticks([-.5, .5])
    ax.set_xticklabels(names,rotation='horizontal', fontsize=30)
    ax.set_yticklabels([])
    # plt.show()
    # plt.tight_layout()
...
palplot(np.array(d3_269_colors_rgb)[:6]/255)
